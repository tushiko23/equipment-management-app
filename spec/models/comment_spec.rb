...
RSpec.describe Comment, type: :model do
  ...
  let!(:user) { User.create!(email: "test@example.com", password: "password123", name: "テスト太郎") }
  let!(:item) { Item.create!(name: "MacBook", unique_id: "999", category: category, state: :available) }
